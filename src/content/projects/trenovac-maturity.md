---
title: Trénovač maturity
description: A tool to practice for the Czech state high school exit exam
description_cs: Nástroj pro procvičování na českou státní maturitní zkoušku
featured: true
tags: [ java, school, maturita, cermat ]
image: https://github.com/PanJohnny/trenovac-maturity/raw/master/big.svg)
links: [
  {
    title: "GitHub",
    url: "https://github.com/PanJohnny/trenovac-maturity",
    icon: "mdi:github"
  },
  {
    title: "Releases",
    url: "https://github.com/PanJohnny/trenovac-maturity/releases",
    icon: "mdi:tag"
  }
]
---
...
![hlavní obrazovka](https://github.com/PanJohnny/trenovac-maturity/raw/master/docs/welcome.png)

## Instalace

**Installery**:
Ze stránky releases na GitHubu stáhněte installer.
...
![testová obrazovka](https://github.com/PanJohnny/trenovac-maturity/raw/master/docs/in-exam.png)
...
![obrazovka přiřazení odpovědí](https://github.com/PanJohnny/trenovac-maturity/raw/master/docs/answer-assign.png)
...
![new-training.png](https://github.com/PanJohnny/trenovac-maturity/raw/master/docs/new-training.png)
